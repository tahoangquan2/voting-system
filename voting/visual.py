import cv2
import pandas as pd
import numpy as np  # Added the missing numpy import
import ast
import os
...
class BoundingBoxVisualizer:
    ...
    def draw_bounding_box(self, image, coords: List[Tuple[int, int]], color: Tuple[int, int, int]):
        """
    ...
    def process_page(self, page_number: int, output_folder: str = "output"):
        ...
        for _, row in page_boxes.iterrows():
            ...
            if coords:
                ...
                self.draw_bounding_box(image, coords, color)
...
def main():
    # Example usage
    csv_path = "matched_boxes.csv"  # Path to your CSV file
